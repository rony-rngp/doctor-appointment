        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="quickForm" action="{{ route('admin.withdrawal-method.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="name">Method Name</label>
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Method Name" >
                                    <span style="color:red">{{ $errors->has('name') ? $errors->first('name') : '' }}</span>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="account_type">Account Type <i class="text-danger">(Optional)</i></label>
                                    <input type="text" class="form-control" data-role="tagsinput" id="account_type" name="account_type" value="{{ old('name') }}" placeholder="Account Type" >
