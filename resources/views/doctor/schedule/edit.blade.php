        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="quickForm" action="{{ route('doctor.schedule.update',$schedule->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="clinic_name" name="clinic_name" value="{{ $schedule->clinic_name }}" placeholder="Clinic or Hospital Name" >
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="clinic_address" name="clinic_address" value="{{ $schedule->clinic_address }}" placeholder="Clinic or Hospital Address" >
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="maximum_patient" name="maximum_patient" value="{{ $schedule->maximum_patient }}" placeholder="Maximum Patient" >
                                    <span style="color:red">{{ $errors->has('maximum_patient') ? $errors->first('maximum_patient') : '' }}</span>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="start_time">Start Time</label>
                                    <input type="text" class="form-control" id="start_time" name="start_time" value="{{ $schedule->start_time }}" placeholder="Start Time" >
                                    <span style="color:red">{{ $errors->has('start_time') ? $errors->first('start_time') : '' }}</span>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="end_time">End Time</label>
                                    <input type="text" class="form-control" id="end_time" name="end_time" value="{{ $schedule->end_time }}" placeholder="End Time" >
