<div class="navbar-custom">
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ file_exists(Auth::guard('doctor')->user()->image) ? url(Auth::guard('doctor')->user()->image) : asset('public/backend/upload/avatar.png') }}" alt="user-image" class="rounded-circle">
                    <span class="pro-user-name ml-1">
                        {{ Auth::guard('doctor')->user()->name }} ( {{ Auth::guard('doctor')->user()->amount }} ) <i class="mdi mdi-chevron-down"></i>
                    </span>
                </a>
        ...
        <!-- LOGO -->
        <div class="logo-box">
            <a href="{{ route('doctor.dashboard') }}" class="logo logo-dark text-center">
                    <span class="logo-sm">
            ...
            <a href="{{ route('doctor.dashboard') }}" class="logo logo-light text-center">
                <span class="logo-sm">
                    <img src="{{ asset('public/backend') }}/assets/images/logo-sm.png" alt="" height="22">
                </span>
                <span class="logo-lg">
